...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return factoryService.userService.Register(email, password);
        }
        ...
        {
            return factoryService.userService.Login(email, password);
        }
        ...
        {
            return factoryService.userService.Logout(email);
        ...
        {
            return factoryService.boardService.LimitColumn(email, boardName, columnOrdinal, limit);  
        }
        ...
        {
            return factoryService.boardService.GetColumnLimit(email, boardName, columnOrdinal);
        }
        ...
        {
            return factoryService.boardService.GetColumnName(email, boardName, columnOrdinal);
        }
        ...
        {
             return factoryService.boardService.AddTask(email, boardName, title, description, dueDate) ;
        }
        ...
        {
            return factoryService.taskService.UpdateTaskDueDate(email, boardName, columnOrdinal, taskId, dueDate);
        ...
        {
            return factoryService.taskService.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
        }
        ...
        {
            return factoryService.taskService.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description);
        }
        ...
        {
            return factoryService.boardService.AdvanceTask(email, boardName, columnOrdinal, taskId);
        }
        ...
        {
            return factoryService.boardService.GetColumn(email, boardName, columnOrdinal);
        }
        ...
        {
            return factoryService.boardService.CreateBoard(email,name);
        }
        ...
        {
            return factoryService.boardService.DeleteBoard(email,name);
        }
        ...
        {
            return factoryService.boardService.InProgressTasks(email);
        }
        //---------------------------------------------------------------------------------------------------------
        ...
        {
            return factoryService.boardService.GetUserBoards(email);
        }
        ...
        {
            return factoryService.boardService.JoinBoard(email, boardID);
        }
        ...
        {
            return factoryService.boardService.LeaveBoard(email, boardID);
        }
        ...
        {
           return factoryService.boardService.AssignTask(email,boardName, columnOrdinal, taskID, emailAssignee);
        }
        ...
        {
            return factoryService.boardService.GetBoardName(boardId);
        }
        ...
        {
            return factoryService.boardService.TransferOwnership(currentOwnerEmail, newOwnerEmail, boardName);
        }
        ...
        {
            return factoryService.LoadData();
        }
        ...
        {
            return factoryService.DeleteData();
        }
    }
}
